	...
	<body>
		...
		<div id="show-post" class="content scaffold-show" role="main">
			...
			<ol class="property-list post">
				...
				<g:if test="${postInstance?.isAllowed}">
				<li class="fieldcontain">
					<span id="isAllowed-label" class="property-label"><g:message code="post.isAllowed.label" default="Is Allowed" /></span>
					
						<span class="property-value" aria-labelledby="isAllowed-label"><g:formatBoolean boolean="${postInstance?.isAllowed}" /></span>
